 ...
 *
 * @author Mudassir Ashraf 501117907
 */
package coe318.lab1;
...
if (voltage>=-50 & voltage<=50){
    ...
    else{System.out.println("Error: value beyond limit");
...
//FIX THIS
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Its power is "
                + r1.getPower() + " Watts");
        System.out.println("Creating a 120 Ohm resistor (r2)");
